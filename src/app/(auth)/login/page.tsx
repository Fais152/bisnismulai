...
import { TrendingUp, ArrowRight, Github } from "lucide-react";
...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col md:flex-row">
      {/* Left side - Branding */}
      <div className="hidden md:flex flex-1 flex-col justify-between p-12 bg-card border-r border-border/40 relative overflow-hidden">
        <div className="absolute top-0 right-0 w-full h-full bg-primary/5 blur-[100px] pointer-events-none" />
        ...
        <div className="relative z-10 max-w-md">
          <h1 className="text-4xl font-bold mb-4 leading-tight">Selamat Datang Kembali</h1>
          <p className="text-muted-foreground text-lg">
            Teruskan perjalanan membangun bisnis Anda dengan sistematis dan terukur.
          </p>
        </div>
